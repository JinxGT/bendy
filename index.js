...
bot.on('message', message => {
	if (message.content === '-help_old') {
		message.channel.send('This bot is currently under development by the **Wampus Development Group**, and this command is currently unavailable!');
	}
});
